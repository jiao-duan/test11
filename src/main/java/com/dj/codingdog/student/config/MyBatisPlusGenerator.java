...
public class MyBatisPlusGenerator {
    public static void main(String[] args) {
        String classDir = CodeGenerator.class.getResource("/").getPath();
        String projectPath = classDir.replace("/target/classes", "");
        // scanner("模块名");
        ...
        autoGenerator.setStrategy(initStrategyConfig(tableNames.split(",")));
